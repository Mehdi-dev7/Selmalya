export default function Banner2() {
  return (
    <div>
      <div>
        <div>
        <h1>Pourquoi choisir Selmalya ?</h1>
						<p>
							 🔹 Une expertise 100% dédiée aux
							pharmacies 🔹 Une approche personnalisée et un suivi régulier 🔹
							Une maîtrise approfondie des réglementations en vigueur 🔹 Un gain
							de temps précieux pour vous concentrer sur vos patients Chez
							Selmalya, nous privilégions une relation de proximité et de
