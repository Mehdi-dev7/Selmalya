		...
		<section className="bg-light min-h-[1000px]">
			<div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-8 pt-20">
				...
				<div className="containers mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 sm:px-6 md:px-8 py-14 md:py-10">
					{/* Logiciels items */}
					<div className="flex flex-col gap-8 justify-center items-center lg:items-start w-full mx-auto lg:ml-0 mb-5">
						{softwares.map((software) => (
							<div
								key={software.id}
								className="bg-mint/20 rounded-2xl flex flex-row gap-4 items-center justify-start p-2 py-2 w-full max-w-md hover:bg-light/90 hover:scale-110 duration-300 hover:shadow-2xl"
							>
								<Image
									src={software.icon}
									alt={software.title}
