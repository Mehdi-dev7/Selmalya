		...
		<section className="bg-light min-h-[800px] sm:min-h-screen flex items-center justify-center py-10 sm:py-16">
			<div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4 sm:px-6 md:px-8">
				...
				<div className="flex justify-center items-center">
					...
					<motion.div
						className="relative w-[200px] md:w-[250px] lg:w-[300px] xl:w-[350px] 2xl:w-[400px] h-[200px] md:h-[250px] lg:h-[300px] xl:h-[350px] 2xl:h-[400px] rounded-full overflow-hidden border-4 border-white shadow-lg"
						initial={{ x: 50, opacity: 0 }}
						animate={{ x: 0, opacity: 1 }}
