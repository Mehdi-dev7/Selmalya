		...
		<section className="bg-light overflow-hidden relative min-h-screen flex items-center justify-center px-4 md:px-6">
			<div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center w-full">
				...
				<div className="flex justify-center items-center mb-15 md:mb-30">
					...
					<motion.div
						className="relative w-[200px] md:w-[250px] lg:w-[300px] xl:w-[350px] 2xl:w-[400px] h-[200px] md:h-[250px] lg:h-[300px] xl:h-[350px] 2xl:h-[400px] rounded-full overflow-hidden border-4 border-white shadow-lg mb-5 md:mt-0"
						initial={{ x: 50, opacity: 0 }}
						animate={{ x: 0, opacity: 1 }}
				...
				<div className="flex flex-col items-center md:items-start text-center md:text-left space-y-5">
					<motion.h1
						className="text-5xl md:text-6xl lg:text-8xl xl:text-8xl 2xl:text-9xl font-bold"
						initial="initial"
						animate="animate"
						variants={FadeUp(0.5)}
					>
